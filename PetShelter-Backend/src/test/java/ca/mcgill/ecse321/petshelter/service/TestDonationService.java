...
public class TestDonationService {
	...
	public void setMockOutput() {
		...
		lenient().when(donationRepository.findDonationsByUserUserNameAndAmount(anyString(), anyDouble()))
	 ...
	 * 
	 * @Test public void testCreatePerson() { UserDTO userDTO = new UserDTO();
	 * UserType userType = USER;
	 * 
	 * userDTO.setEmail(USER_EMAIL); userDTO.setPassword(USER_PASSWORD);
	 * userDTO.setUsername(USER_NAME); userDTO.setUserType(userType);
	 * 
	 * try { userService.createUser(userDTO); } catch (RegisterException e) {
	 * e.printStackTrace(); } User e = userRepository.findUserByUserName(USER_NAME);
	...
	public void testDonation() {
		...
		assertTrue(DONATION_AMOUNT == donation.getAmount());
	}
	...
	public void testAnonymousDonation() {
		...
		assertTrue(amount == dto.getAmount());
	}
