...
public class PetService {
	...
	public PetDTO createPet(PetDTO petDTO) {
		...
		if (advertisementRepository.findAdvertisementById(petDTO.getAdvertisement().getId()) != null) {
		   pet.setAdvertisement(advertisementRepository.findAdvertisementById(petDTO.getAdvertisement().getId()));
		}
